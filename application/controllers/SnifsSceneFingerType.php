...
class SnifsSceneFingerType extends CI_Controller {

    public static $path = "snifsSceneFingerType/";
    ...
    public function index() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->header['jsFile'] = array('/assets/system/core/nifsSceneFingerType.js');
            ...
            $this->load->view(MY_ADMIN . '/nifsSceneFingerType/index', $this->body);
    ...
    public function lists() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            //total rows count
            $totalRec = $this->nifsSceneFingerType->listsCount_model(array(
            ...
            //get posts data
            echo json_encode($this->nifsSceneFingerType->lists_model(array(
            ...
            //load the view
            //$this->load->view(MY_ADMIN . '/nifsSceneFingerType/lists', $data, false);
        }
    }
    ...
    public function add() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->nifsSceneFingerType->addFormData_model();
            ...
            echo json_encode(array(
                ...
                'btn_yes' => 'Хадгалах',
                'btn_no' => 'Хаах',
                'html' => $this->load->view(MY_ADMIN . '/nifsSceneFingerType/form', $this->body, TRUE)
            ));
        } else {
            redirect(MY_ADMIN);
        }
    ...
    public function edit() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->nifsSceneFingerType->editFormData_model(array('id' => $this->input->post('id')));
            ...
            echo json_encode(array(
                ...
                'btn_yes' => 'Хадгалах',
                'btn_no' => 'Хаах',
                'html' => $this->load->view(MY_ADMIN . '/nifsSceneFingerType/formEdit', $this->body, TRUE)
            ));
        } else {
            redirect(MY_ADMIN);
        }
    ...
    public function insert() {
        echo json_encode($this->nifsSceneFingerType->insert_model());
    }

    public function update() {
        echo json_encode($this->nifsSceneFingerType->update_model());
    }

    public function delete() {
        echo json_encode($this->nifsSceneFingerType->delete_model());
    }
    ...
    function searchForm() {
        ...
        echo json_encode(array(
            ...
            'html' => $this->load->view(MY_ADMIN . '/nifsSceneFingerType/formSearch', $this->body, TRUE),
            'btn_yes' => 'Хайх',
            'btn_no' => 'Болих'
        ));
    }

    public function controlNifsSceneFingerTypeDropdown() {
        echo json_encode($this->nifsSceneFingerType->controlNifsSceneFingerTypeDropdown_model(array(
            'catId' => $this->input->get('catId'), 
