...
class Slearning extends CI_Controller {

    public static $path = "slearning/";

    function __construct() {
        parent::__construct();
        $this->load->model('Spage_model', 'page');
        $this->load->model('Slearning_model', 'slearning');
    ...
    public function index() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->footer['jsFile'] = array('/assets/system/core/_learning.js', '/assets/system/core/_comment.js');
            ...
            $this->load->view(MY_ADMIN . '/learning/index');
    ...
    public function catLists() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            echo json_encode($this->slearning->catLists_model(array(
                        'isBackButton' => 0,
    ...
    public function categoryShow() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            if ($this->category->isChild_model($this->input->get('catId'))) {
                $this->body['html'] = $this->slearning->catLists_model(array(
                    'isBackButton' => 1,
                    'title' => $this->module->title,
                ...
                //total rows count
                $totalRec = $this->slearning->listsCount_model(array(
                    'moduleMenuId' => $this->uri->segment(3),
                    'modId' => $this->modId,
                    'catId' => $this->input->get('catId'),
                    'partnerId' => $this->input->get('partnerId'),
                ...
                //get posts data
                $this->body['html'] = $this->slearning->lists_model(array(
                    'title' => $this->module->title,
                    'moduleMenuId' => $this->uri->segment(3),
                    'modId' => $this->modId,
                    'catId' => $this->input->get('catId'),
            ...
            $this->load->view(MY_ADMIN . '/header', $this->header);
            $this->load->view(MY_ADMIN . '/learning/categoryShow', $this->body);
            $this->load->view(MY_ADMIN . '/footer', $this->footer);
        }
    }
    ...
    public function lists() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            //get posts data
            echo json_encode($this->slearning->lists_model(array(
                        'title' => $this->module->title,
                        'moduleMenuId' => $this->input->get('moduleMenuId'),
                        'modId' => $this->modId,
                        'catId' => $this->input->get('catId'),
    ...
    public function show() {
        ...
        $this->body['row'] = $this->slearning->getItem_model(array('selectedId' => ($this->input->get('selectedId') != null ? $this->input->get('selectedId') : $this->uri->segment(3))));
        ...
        $this->body['relatedList'] = '' /* $this->slearning->relatedList_model(array(
        ...
        if ($this->input->is_ajax_request()) {
            ...
            echo json_encode($this->load->view(MY_ADMIN . '/learning/show', $this->body, TRUE));
        } else {

            $this->footer['jsFile'] = array('/assets/system/core/_learning.js', '/assets/system/core/_comment.js');

            $this->load->view(MY_ADMIN . '/header', $this->header);
            $this->load->view(MY_ADMIN . '/learning/show', $this->body);
            $this->load->view(MY_ADMIN . '/footer', $this->footer);
        }
    }
    ...
    public function showMediaItem() {
        ...
        echo json_encode(array(
            ...
            'btn_close' => 'Хаах',
            'html' => $this->load->view(MY_ADMIN . '/learning/showMediaItem', $this->body, TRUE)));
    }
    ...
    public function searchForm() {
        if ($this->session->isLogin === TRUE) {
            ...
            echo json_encode(array(
                ...
                'btn_yes' => 'Хайх',
                'btn_no' => 'Хаах',
                'html' => $this->load->view(MY_ADMIN . '/learning/formSearch', $this->body, TRUE)
            ));
        } else {
            redirect(MY_ADMIN);
        }
...
//Tumendemberel - 
        ...
        //total rows count
        $totalRec = $this->slearning->mListsCount_model(array(
        ...
        //get posts data
        echo json_encode($this->slearning->mLists_model(array(
                    'authentication' => $authenticationData,
                    'title' => $this->module->title,
                    'moduleMenuId' => $this->input->get('moduleMenuId'),
                    'modId' => $this->modId,
