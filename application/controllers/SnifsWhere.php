...
class SnifsWhere extends CI_Controller {

    public static $path = "snifsWhere/";
    ...
    public function index() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->header['jsFile'] = array('/assets/system/core/nifsWhere.js');
            ...
            $this->load->view(MY_ADMIN . '/nifsWhere/index', $this->body);
    ...
    public function lists() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            //total rows count
            $totalRec = $this->nifsWhere->listsCount_model(array(
            ...
            //get posts data
            echo json_encode($this->nifsWhere->lists_model(array(
            ...
            //load the view
            //$this->load->view(MY_ADMIN . '/nifsWhere/lists', $data, false);
        }
    }
    ...
    public function add() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->nifsWhere->addFormData_model();
            ...
            echo json_encode(array(
                ...
                'btn_yes' => 'Хадгалах',
                'btn_no' => 'Хаах',
                'html' => $this->load->view(MY_ADMIN . '/nifsWhere/form', $this->body, TRUE)
            ));
        } else {
            redirect(MY_ADMIN);
        }
    ...
    public function edit() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->nifsWhere->editFormData_model(array('id' => $this->input->post('id')));
            ...
            echo json_encode(array(
                ...
                'btn_yes' => 'Хадгалах',
                'btn_no' => 'Хаах',
                'html' => $this->load->view(MY_ADMIN . '/nifsWhere/formEdit', $this->body, TRUE)
            ));
        } else {
            redirect(MY_ADMIN);
        }
    ...
    public function insert() {
        echo json_encode($this->nifsWhere->insert_model());
    }

    public function update() {
        echo json_encode($this->nifsWhere->update_model());
    }

    public function delete() {
        echo json_encode($this->nifsWhere->delete_model());
    }
    ...
    function searchForm() {
        ...
        echo json_encode(array(
            ...
            'html' => $this->load->view(MY_ADMIN . '/nifsWhere/formSearch', $this->body, TRUE),
            'btn_yes' => 'Хайх',
            'btn_no' => 'Болих'
        ));
    }

    public function controlNifsWhereDropdown() {
        echo json_encode($this->nifsWhere->controlNifsWhereDropdown_model(array('catId' => $this->input->get('catId'), 'selectedId' => $this->input->get('selectedId'))));
    }
