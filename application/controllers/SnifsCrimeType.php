...
class SnifsCrimeType extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->header['jsFile'] = array('/assets/system/core/nifsCrimeType.js');
            ...
            $this->load->view(MY_ADMIN . '/nifsCrimeType/index', $this->body);
    ...
    public function lists() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            //total rows count
            $totalRec = $this->nifsCrimeType->listsCount_model(array(
            ...
            //get posts data
            echo json_encode($this->nifsCrimeType->lists_model(array(
    ...
    public function add() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->nifsCrimeType->addFormData_model();
    ...
    public function edit() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->nifsCrimeType->editFormData_model(array('id' => $this->input->post('id')));
    ...
    public function insert() {
        echo json_encode($this->nifsCrimeType->insert_model());
    }

    public function update() {
        echo json_encode($this->nifsCrimeType->update_model());
    }

    public function delete() {
        echo json_encode($this->nifsCrimeType->delete_model());
    }
    ...
    public function controlNifsCrimeTypeDropdown() {
        echo json_encode($this->nifsCrimeType->controlNifsCrimeTypeDropdown_model(array('catId' => $this->input->get('catId'), 'selectedId' => $this->input->get('selectedId'))));
    }
