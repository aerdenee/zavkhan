...
class Sorgdirectory extends CI_Controller {

    public static $path = "sorgdirectory/";

    function __construct() {
        parent::__construct();
        $this->load->model('Spage_model', 'page');
        $this->load->model('Sorgdirectory_model', 'orgdirectory');
    ...
    public function index() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->header['jsFile'] = array('/assets/system/core/orgdirectory.js', '/assets/system/core/map.js');
            $this->body = array();
            ...
            $config["total_rows"] = $this->orgdirectory->listsCount_model(array('modId' => $this->body['modId'], 'keyword' => $this->input->get('keyword'), 'catId' => $this->input->get('catId'), 'organizationId' => $this->input->get('campId')));
            ...
            $this->body['dataHtml'] = $this->orgdirectory->lists_model(array(
            ...
            $this->load->view(MY_ADMIN . '/orgdirectory/index', $this->body);
    ...
    public function add() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->header['cssFile'] = array();
            $this->header['jsFile'] = array('/assets/editor/ckeditor/ckeditor.js', '/assets/system/core/orgdirectory.js', '/assets/system/core/map.js');
            $this->body = array();
            ...
            $this->body['row'] = $this->orgdirectory->addFormData_model();
            ...
            $this->load->view(MY_ADMIN . '/header', $this->header);
            $this->load->view(MY_ADMIN . '/orgdirectory/formGeneral', $this->body);
            $this->load->view(MY_ADMIN . '/footer');
        } else {
            redirect(MY_ADMIN);
        }
    ...
    public function edit() {
        ...
        if ($this->session->isLogin === TRUE) {
            ...
            $this->body['row'] = $this->orgdirectory->editFormData_model(array('id' => $this->uri->segment(4)));
            
            if ($this->body['row']['directory_social'] == '') {
                $this->body['row']['directory_social'] = $this->orgdirectory->socialDefault_model();
            }
    ...
    public function insert() {
        ...
        echo json_encode($this->orgdirectory->insert_model(array('pic' => $this->newFile, 'getUID' => $this->getUID)));
    }
    ...
    public function update() {
        ...
        echo json_encode($this->orgdirectory->update_model(array('pic' => $this->newFile)));
    }

    public function delete() {
        echo json_encode($this->orgdirectory->delete_model());
    }
    ...
    public function updateVerticalImage() {
        ...
        echo json_encode($this->orgdirectory->updateVerticalImage_model(array('pic' => $this->newFile, 'id' => $this->input->post('id'))));
    }
    ...
    public function mediaForm() {
        ...
        $data['row'] = $this->orgdirectory->mediaAddFormData_model();
        if ($this->input->post('mode') == 'mediaUpdate') {
            $data['row'] = $this->orgdirectory->mediaEditFormData_model(array('id' => $this->input->post('mediaId')));
        }

        echo json_encode(
                array(
                    "title" => "Медиа файл",
                    "html" => $this->load->view(MY_ADMIN . '/orgdirectory/formMedia', $data, true),
                    "btn_ok" => "Хадгалах",
                    "btn_no" => "Хаах"));
    }
    ...
    public function mediaInsert() {
        ...
        if ($this->orgdirectory->mediaInsert_model(array('fileNameMn' => $this->newFile['nameMn'], 'fileNameEn' => $this->newFile['nameEn'], 'fileTypeMn' => $this->newFile['fileTypeMn'], 'fileTypeEn' => $this->newFile['fileTypeEn']))) {
    ...
    public function mediaUpdate() {
        ...
        if ($this->input->post('type') == 1) {
            ...
            $this->newFile['nameMn'] = ($this->input->post('videoIdMn') != '' ? $this->input->post('videoIdMn') : $this->input->post('oldAttachFileMn'));
            $this->newFile['fileTypeMn'] = $this->input->post('oldFileTypeMn');
                
            $this->newFile['nameEn'] = ($this->input->post('videoIdEn') != '' ? $this->input->post('videoIdEn') : $this->input->post('oldAttachFileEn'));
            $this->newFile['fileTypeEn'] = $this->input->post('oldFileTypeEn');
        ...
        if ($this->orgdirectory->mediaUpdate_model(array('fileNameMn' => $this->newFile['nameMn'], 'fileNameEn' => $this->newFile['nameEn'], 'fileTypeMn' => $this->newFile['fileTypeMn'], 'fileTypeEn' => $this->newFile['fileTypeEn']))) {
            echo json_encode(array('status' => 'success', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function mediaList() {
        echo json_encode($this->orgdirectory->mediaList_model(array('modId' => $this->input->post('modId'), 'contId' => $this->input->post('contId'), 'type' => $this->input->post('type'))));
    }

    public function mediaDelete() {
        echo json_encode($this->orgdirectory->mediaDelete_model());
    }
    ...
    function searchForm() {
        ...
        echo json_encode(array(
            ...
            'html' => $this->load->view(MY_ADMIN . '/orgdirectory/formSearch', $this->body, TRUE),
            'btn_yes' => 'Хайх',
            'btn_no' => 'Болих'
        ));
    }
    ...
    public function tourBackground() {
        echo json_encode($this->orgdirectory->tourBackground_model());
    }

    public function tourIncludedService() {
        echo json_encode($this->orgdirectory->tourIncludedService_model());
    }

    public function tourItineraryList() {
        echo json_encode($this->orgdirectory->tourItineraryList_model(array('modId' => $this->input->post('modId'), 'contId' => $this->input->post('contId'))));
    }
    ...
    public function formTourItinerary() {
        ...
        $this->data['type'] = 5;
        $this->data['row'] = $this->orgdirectory->mediaAddFormData_model();
        if ($this->input->post('mode') == 'tourItineraryUpdate') {
            $this->data['row'] = $this->orgdirectory->mediaEditFormData_model(array('id' => $this->input->post('mediaId')));
        }

        echo json_encode(
                array(
                    "title" => "Tour itinerary",
                    "html" => $this->load->view(MY_ADMIN . '/orgdirectory/formTourItinerary', $this->data, true),
                    "btn_ok" => "Хадгалах",
                    "btn_no" => "Хаах"));
    }

    public function tourItineraryInsert() {
        if ($this->orgdirectory->tourItineraryInsert_model()) {
    ...
    public function tourItineraryUpdate() {
        if ($this->orgdirectory->tourItineraryUpdate_model()) {
            echo json_encode(array('status' => 'success', 'title' => 'Амжилттай', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'title' => 'Алдаа', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function tourItineraryDelete() {
        echo json_encode($this->orgdirectory->tourItineraryDelete_model());
    }
    ...
    public function timeLineForm() {
        ...
        $data['modId'] = $this->input->post('modId');
        $data['mediaId'] = $this->input->post('mediaId');
        $data['row'] = $this->orgdirectory->timeLineAddFormData_model();
        if ($this->input->post('mode') == 'timeLineUpdate') {
            $data['row'] = $this->orgdirectory->timeLineEditFormData_model(array('id' => $this->input->post('mediaId')));
        }

        echo json_encode(
                array(
                    "title" => "Медиа файл",
                    "html" => $this->load->view(MY_ADMIN . '/orgdirectory/formTimeLine', $data, true),
                    "btn_ok" => "Хадгалах",
                    "btn_no" => "Хаах"));
    }
    ...
    public function timeLineInsert() {
        ...
        if ($this->orgdirectory->timeLineInsert_model(array('fileNameMn' => $this->newFileMn, 'fileNameEn' => $this->newFileEn))) {
            echo json_encode(array('status' => 'success', 'title' => 'Амжилттай', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'title' => 'Алдаа', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function timeLineUpdate() {
        ...
        if ($this->orgdirectory->timeLineUpdate_model(array('fileNameMn' => $this->newFileMn, 'fileNameEn' => $this->newFileEn))) {
            echo json_encode(array('status' => 'success', 'title' => 'Амжилттай', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'title' => 'Алдаа', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function timeLineList() {
        echo json_encode($this->orgdirectory->timeLineList_model(array('modId' => $this->input->post('modId'), 'contId' => $this->input->post('contId'), 'type' => $this->input->post('type'))));
    }

    public function timeLineDelete() {
        echo json_encode($this->orgdirectory->timeLineDelete_model());
    }
    ...
    public function ourTeamForm() {
        ...
        $data['modId'] = $this->input->post('modId');
        $data['mediaId'] = $this->input->post('mediaId');
        $data['row'] = $this->orgdirectory->ourTeamAddFormData_model();
        if ($this->input->post('mode') == 'ourTeamUpdate') {
            $data['row'] = $this->orgdirectory->ourTeamEditFormData_model(array('id' => $this->input->post('mediaId')));
        }

        echo json_encode(
                array(
                    "title" => "Медиа файл",
                    "html" => $this->load->view(MY_ADMIN . '/orgdirectory/formOurTeam', $data, true),
                    "btn_ok" => "Хадгалах",
                    "btn_no" => "Хаах"));
    }
    ...
    public function ourTeamInsert() {
        ...
        echo json_encode($this->orgdirectory->ourTeamInsert_model(array('fileNameMn' => $this->newFile, 'fileNameEn' => $this->newFile)));
    }
    ...
    public function ourTeamUpdate() {
        ...
        if ($this->orgdirectory->ourTeamUpdate_model(array('fileNameMn' => $this->newFile, 'fileNameEn' => $this->newFile))) {
            echo json_encode(array('status' => 'success', 'title' => 'Амжилттай', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'title' => 'Алдаа', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function ourTeamList() {
        echo json_encode($this->orgdirectory->ourTeamList_model(array('modId' => $this->input->post('modId'), 'contId' => $this->input->post('contId'), 'type' => $this->input->post('type'))));
    }

    public function ourTeamDelete() {
        echo json_encode($this->orgdirectory->ourTeamDelete_model());
    }
    ...
    public function attachFileForm() {
        ...
        $data['modId'] = $this->input->post('modId');
        $data['mediaId'] = $this->input->post('mediaId');
        $data['row'] = $this->orgdirectory->attachFileAddFormData_model();
        if ($this->input->post('mode') == 'attachFileUpdate') {
            $data['row'] = $this->orgdirectory->attachFileEditFormData_model(array('id' => $this->input->post('mediaId')));
        }

        echo json_encode(
                array(
                    "title" => "Хавсралт файл",
                    "html" => $this->load->view(MY_ADMIN . '/orgdirectory/formAttachFile', $data, true),
                    "btn_ok" => "Хадгалах",
                    "btn_no" => "Хаах"));
    }
    ...
    public function attachFileInsert() {
        ...
        if ($this->orgdirectory->attachFileInsert_model(array('fileNameMn' => $this->newFileMn, 'fileNameEn' => $this->newFileEn))) {
            echo json_encode(array('status' => 'success', 'title' => 'Амжилттай', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'title' => 'Алдаа', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function attachFileUpdate() {
        ...
        if ($this->orgdirectory->attachFileUpdate_model(array('fileNameMn' => $this->newFileMn, 'fileNameEn' => $this->newFileEn))) {
            echo json_encode(array('status' => 'success', 'title' => 'Амжилттай', 'message' => 'Амжилттай хадгаллаа...'));
        } else {
            echo json_encode(array('status' => 'error', 'title' => 'Алдаа', 'message' => 'Хадгалах үед алдаа гарлаа...'));
        }
    ...
    public function attachFileList() {
        echo json_encode($this->orgdirectory->attachFileList_model(array('modId' => $this->input->post('modId'), 'contId' => $this->input->post('contId'), 'type' => $this->input->post('type'))));
    }

    public function attachFileDelete() {
        echo json_encode($this->orgdirectory->attachFileDelete_model());
    }
