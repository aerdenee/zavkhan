...
<fieldset>
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group">
            <?php echo form_label('Хэрэг болсон огноо', 'Хэрэг болсон огноо', array('required' => 'required', 'class' => 'col-md-4 control-label text-right', 'defined' => TRUE)); ?>
            <div class="col-md-8">
                <?php
                echo form_input(array(
                    'name' => 'crimeDate',
                    'id' => 'crimeDate',
                    'value' => date('Y-m-d', strtotime($row->crime_date)),
                    'maxlength' => '10',
                    'class' => 'form-control read-date',
                    'readonly' => true
                ));
        ...
        <div id="initDoctorViewControlShortValueHtml">
            <?php
            if ($row->short_value_id != '7') {
                echo form_hidden('shortValue', '');
            } else {
                echo '<div class="form-group"><label class="col-md-4 control-label text-right"></label><div class="col-md-8"><textarea name="shortValue" row="2" class="form-control" readonly="true">' . $row->short_value . '</textarea></div></div>';
            }
        ?></div>
        <div class="form-group">
        ...
        <div class="form-group">
            <?php echo form_label('Төлбөр', 'Төлбөр', array('required' => 'required', 'class' => 'control-label col-md-4 text-right', 'defined' => TRUE)); ?>
            <div class="col-md-8">
                <div class="radio-list">
                    <label class="radio-inline">
                        <?php echo form_radio(array('name' => 'payment', 'class' => 'radio', 'disabled' => true), 1, (intval($row->payment) == 1 ? TRUE : '')); ?>
                        Төлсөн </label>
                    <label class="radio-inline">
                        <?php echo form_radio(array('name' => 'payment', 'class' => 'radio', 'disabled' => true), 0, (intval($row->payment) == 0 ? TRUE : '')); ?>
                        Төлөөгүй </label>
                </div>
            </div>
        </div>
