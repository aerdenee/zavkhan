...
<div class="panel panel-flat">
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <ul class="icons-list">
                <li><a href="<?php echo Sdepartment::$path . 'index/' . $modId; ?>"><i class="glyphicon glyphicon-chevron-left"></i> <i class="icon icon-primitive-dot" style="font-size:10px; margin-left:-5px;"></i><i class="icon icon-primitive-dot" style="font-size:10px;"></i><i class="icon icon-primitive-dot" style="font-size:10px;"></i></a></li>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    function _saveForm() {
        ...
        if ($(formId).valid()) {
            $.ajax({
                type: 'post',
                url: '<?php echo Sdepartment::$path . $mode; ?>',
                ...
                success: function (data) {
                    if (data.status === 'success') {
                        ...
                        window.location.href = '<?php echo Sdepartment::$path . 'index/' . $modId; ?>';
                    } else {
                        new PNotify({
                            text: data.message,
                            addclass: 'bg-danger'
