...
<html lang="en">
    ...
    <body class="bg-slate-800">
        <video autoplay="" muted="" loop="" class="_background-video">
            <source src="assets/system/img/backgrounds/default_login.mp4" type="video/mp4">
                ...
                <div class="content d-flex justify-content-center align-items-center">
                    ...
                    <div class="card mb-0" style="border: none;">
                        <div class="card-header bg-primary text-white header-elements-inline">
                            <h6 class="card-title text-center">Агуулга удирдах хуудас</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <span class="form-text text-center text-muted">Програм хангамжтай холбоотой асуудлаар <br><a href="mailto:support@aru.mn">support@aru.mn</a> мэйл хаягаар хандан зөвлөгөө авна уу? </span>
