<ul class="nav nav-tabs nav-tabs-bottom mb-0">
    ...
    <li class="nav-item"><a href="#window-content-gmap" class="nav-link" data-toggle="tab">Газрын зураг</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane fade" id="window-content-comment" data-cont-id="<?php echo $row->id; ?>" data-mod-id="<?php echo $row->mod_id; ?>" data-sort-type="DESC">
        <?php $this->load->view(MY_ADMIN . '/contentComment/lists', array('content' => $row)); ?>
    </div>

    <div class="tab-pane fade" id="window-content-gmap" data-cont-id="<?php echo $row->id; ?>" data-mod-id="<?php echo $row->mod_id; ?>">
        <?php $this->load->view(MY_ADMIN . '/map/google/index', array('content' => $row)); ?>
    </div>
