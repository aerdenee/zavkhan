<?php echo form_open('', array('class' => 'form-horizontal', 'id' => 'form-timeline', 'enctype' => 'multipart/form-data')); ?>
<?php
...
<script type="text/javascript">
    $(function () {
        $('input[name="raiodType"]', '#form-timeline').on('click', function (event) {
            if ($(this).val() == 3) {
                $("#videoIdMn", '#form-timeline').val('');
                $("#videoIdEn", '#form-timeline').val('');
                $(".media-form-video", '#form-timeline').show();
                $(".media-form-photo", '#form-timeline').hide();
                $("input[name='type']", '#form-timeline').val(3);
            } else {
                $(".media-form-video", '#form-timeline').hide();
                $(".media-form-photo", '#form-timeline').show();
                $("input[name='type']", '#form-timeline').val(1);
            }
        });
