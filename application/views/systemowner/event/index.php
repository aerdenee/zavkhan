<div id="window-event"><?php echo $dataHtml; ?></div>
    ...
    function _loadContextMenu() {
        return {
            "add": {
                ...
                icon: "plus",
                callback: function () {
                    window.location = '<?php echo Sevent::$path . 'add/' . $modId; ?>';
                },
            ...
            "edit": {
                ...
                callback: function () {
                    ...
                    window.location = '<?php echo Sevent::$path . 'edit/' . $modId; ?>/' + _tr.attr('data-id');
                },
                disabled: function (key, opt) {
                    var _tr = $(this).parents('tr');
