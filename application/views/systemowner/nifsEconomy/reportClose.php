    ...
    $(function () {
        $.contextMenu({
            ...
            callback: function (key, options) {
                ...
                if (key === 'read') {
                    window.location = '<?php echo Scrime::$path . 'index/' . $modId;?>?departmentId=' + _tr.attr('data-department-id') + '&departmentCatId=' + _tr.attr('data-department-cat-id') + '&startDate=' + _tr.attr('data-start-date') + '&endDate=' + _tr.attr('data-end-date');
                }
            },
            items: {
