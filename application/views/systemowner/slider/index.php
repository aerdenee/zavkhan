...
<div class="row">
    ...
    <div class="col-md-6 text-right">
        <a href="/sslider/<?php echo $modId; ?>/add" class="btn green btn-xs"><i class="fa fa-plus"></i> Нэмэх</a>
            ...
            success: function (data) {
                ...
                $.each(data, function () {
                    ...
                    oTable.fnAddData([
                        ...
                        '<a href="/sslider/' + $elem['modid'] + '/edit/' + $elem['id'] + '"><img src="' + ($elem['file'] != '' ? '/upload/slider/' + $elem['file'] : '/assets/img/default.jpg') + '" style="max-width:60px;"></a>',
                        '<a href="/sslider/' + $elem['modid'] + '/edit/' + $elem['id'] + '">' + $elem['title'] + '</a>',
                        ($elem['publish'] == 1 ? '<a href="/sslider/' + $elem['modid'] + '/id/' + $elem['id'] + '/publish/0"><span class="label label-sm label-success"><i class="fa fa-check"></i> Нийтэлсэн </span></a>' : '<a href="/sslider/' + $elem['modid'] + '/id/' + $elem['id'] + '/publish/1"><span class="label label-sm label-danger"><i class="fa fa-times"></i> Хүлээлгэнд </span></a>'),
                        $elem['ordering'],
