<?php if ($row['id'] != ''): ?>
    ...
    <script type="text/javascript">
        ...
        function formMediaDialog(id, mode) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo Surgudul::$path; ?>formMedia',
                ...
                success: function (data) {
                    ...
                    $("#" + dialogId).dialog({
                        ...
                        buttons: [
                            {text: data.btn_ok, class: 'btn btn-xs green pull-left', click: function () {
        ...
        function initTableMedias() {
            $.ajax({
                url: '<?php echo Surgudul::$path; ?>listsMedia',
                type: 'POST',
                dataType: 'json',
        ...
        function isActiveMedia(isActive, id) {
            $.ajax({
                type: 'post',
                url: '<?php echo Surgudul::$path; ?>isActiveMedia',
                dataType: "json",
            ...
            $("#" + dialogId).dialog({
                ...
                buttons: [
                    {text: "Тийм", class: 'btn btn-xs green pull-left', click: function () {
                            $.ajax({
                                type: 'post',
                                url: '<?php echo Surgudul::$path; ?>deleteMedia',
                                dataType: "json",
                                data: {id: [id]},
                                success: function (data) {
                                    if (data.status === 'success') {
