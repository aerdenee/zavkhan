<ul class="nav nav-tabs nav-tabs-bottom mb-0">
    ...
    <li class="nav-item"><a href="#window-tour-itinerary" class="nav-link" data-toggle="tab">Itinerary</a></li>
    <li class="nav-item"><a href="#window-content-media" class="nav-link" data-toggle="tab">Фото</a></li>
    <li class="nav-item"><a href="#window-content-comment" class="nav-link" data-toggle="tab">Сэтгэгдэл</a></li>
    <li class="nav-item"><a href="#window-tour-calendar" class="nav-link" data-toggle="tab">Календар</a></li>
</ul>

<div class="tab-content">
    <div class="tab-pane fade show active" id="tab-content">
        <?php
        echo form_open('', array('class' => 'form-horizontal p-0', 'id' => 'form-content', 'enctype' => 'multipart/form-data'));
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                ...
                                echo '<span class="_user-image-delete-button" onclick="_imageDelete({table: \'content\', formId: _contentFormMainId, appendHtmlClass: \'._profile-image\', selectedId: ' . $row->id . ', uploadPath: UPLOADS_CONTENT_PATH, fileName: ($(\'input[name=pic]\').val() != \'\' ? $(\'input[name=pic]\').val() : $(\'input[name=oldPic]\').val())});">';
                                ...
                                echo form_upload(array(
                                    ...
                                    'onchange' => '_imageUpload({elem: this, uploadPath: UPLOADS_CONTENT_PATH, formId: _contentFormMainId, appendHtmlClass: \'._profile-image\', table: \'content\', selectedId: ' . $row->id . ', oldPic: ($(\'input[name=pic]\').val() != \'\' ? $(\'input[name=pic]\').val() : $(\'input[name=oldPic]\').val())});',
                                ));
                        ...
                        <div class="form-group row">
                            <?php echo form_label('Аялалын код', 'Аялалын код', array('required' => 'required', 'class' => 'control-label col-md-2 text-right', 'defined' => TRUE)); ?>
                            <div class="col-md-3">
                                <?php
                                echo form_input(array(
                                    'name' => 'code',
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <?php echo form_label('General info', 'General info', array('class' => 'control-label col-md-12', 'defined' => TRUE)); ?>
                                <?php
                                echo form_textarea(array(
                                    'name' => 'fullText',
                                    'id' => 'fullText',
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <?php echo form_label('Tour details', 'Tour details', array('class' => 'control-label col-md-12', 'defined' => TRUE)); ?>
                                <?php
                                echo form_textarea(array(
                                    'name' => 'details',
                                    'id' => 'details',
    ...
    <div class="tab-pane fade" id="window-tour-itinerary" data-cont-id="<?php echo $row->id;?>" data-mod-id="<?php echo $row->mod_id;?>">
        <?php $this->load->view(MY_ADMIN . '/tourItinerary/index', array('content' => $row)); ?>
    </div>
    ...
    <div class="tab-pane fade" id="window-tour-calendar" data-cont-id="<?php echo $row->id;?>" data-mod-id="<?php echo $row->mod_id;?>">
        <?php $this->load->view(MY_ADMIN . '/tourCalendar/index', array('content' => $row)); ?>
    </div>
