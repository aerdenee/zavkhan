<ul class="nav nav-tabs nav-tabs-bottom mb-0">
    ...
    <li class="nav-item"><a href="#bottom-tab2" class="nav-link" data-toggle="tab">Фото</a></li>
...
<div class="tab-content">
    ...
    <div class="tab-pane fade" id="window-tour-itinerary">
        Аялалын хөтөлбөр
    </div>
    ...
    <div class="tab-pane fade" id="window-tour-calendar">
        Засварын горимд ашиглах боломжтой.
    </div>
