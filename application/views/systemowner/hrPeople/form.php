<div class="card container">
    <div class="card-body">
        ...
        echo form_hidden('hrPeopleOldPic', '');
        ...
        <div class="container">
            <div class="row">
                <div class="text-right w-100">
                    ...
                    echo form_button('saveHrPeople', '<i class="icon-paperplane"></i> Хадгалах', 'class="btn btn-primary" onclick="_insertHrPeople({elem: this});"', 'button');
                    ?>
                </div>
            </div>
        </div>
