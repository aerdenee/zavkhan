            ...
            <article class="news-container">
                ...
                <div class="entry-content">
                    <ul class="list-inline entry-meta mb-2 pull-right">
                        <li><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $row->modified_date; ?></li>
                        <li><a href=""><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo $hrPeople->full_name; ?></a></li>
    ...
    <embed src="http://www.youtube.com/v/" type="application/x-shockwave-flash" wmode="transparent"></embed>
        ...
        <div class="col-md-3">
            ...
            <div class="social-widget p-2">
                ...
                <?php 
                $hrPeopleParam = json_decode($hrPeople->param);

                echo ($hrPeopleParam->work->position != '' ? $hrPeopleParam->work->position . ', ' : '') . ($hrPeopleParam->work->rank != '' ? $hrPeopleParam->work->rank . ', ' : '') . ($hrPeopleParam->work->department != '' ? $hrPeopleParam->work->department : '');
