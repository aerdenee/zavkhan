...
<div class="tab-content">
    <div class="tab-pane fade show active" id="tab-content">
        ...
        echo form_hidden('contentPic', '');
        echo form_hidden('contentOldPic', ltrim($row->pic, UPLOADS_CONTENT_PATH . CROP_SMALL));
        ?>
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                ...
                                echo '<img src="' . $row->pic . '" class="_content-image">';
                                echo '<span class="_user-image-delete-button" onclick="_imageDelete({table: \'content\', formId: _contentFormMainId, appendHtmlClass: \'._content-image\', selectedId: ' . $row->id . ', uploadPath: UPLOADS_CONTENT_PATH, prefix: \'content\'});">';
                                echo '<i class="fa fa-trash-o" style="user-select: none;"></i>';
                                echo '</span>';
                                echo '<span class="_user-image-upload-button">';
                                echo '<div class="uploader">';
                                echo form_upload(array(
                                    'name' => 'contentPicUpload',
                                    'id' => 'contentPicUpload',
                                    'class' => 'pull-left file-styled',
                                    'onchange' => '_imageUpload({
                                        elem: this, 
                                        uploadPath: UPLOADS_CONTENT_PATH, 
                                        formId: _contentFormMainId, 
                                        appendHtmlClass: \'._content-image\', 
                                        prefix: \'content\'});',
                                ));
                ...
                <div id="accordion-item-group3" class="collapse" data-parent="#accordion-group">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <?php echo form_label('Үзсэн тоо', 'Үзсэн тоо', array('required' => 'required', 'class' => 'control-label col-md-3 text-right', 'defined' => TRUE)); ?>
                            <div class="col-md-7">
