                    ...
                    <div class="tab-pane has-padding active" id="right-content-language-<?php echo $this->session->adminDefaultLanguage->code; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                ...
                                echo '<span class="_user-image-delete-button" onclick="_imageDelete({modId: ' . $row->mod_id . ', selectedId: ' . $row->id . ', uploadPath: UPLOADS_CONTENT_PATH, dbFieldName: \'pic\', fieldName: \'pic\', oldFieldName: \'oldPic\', fileName:  ($(\'input[name=pic]\').val() != \'\' ? $(\'input[name=pic]\').val() : $(\'input[name=oldPic]\').val()), isMedia: 0, formId: _hrAdsFormMainId, appendHtmlClass: \'._profile-image\'});">';
