...
<div class="form-group row">
    ...
    <div class="col-md-8">
        ...
        echo form_input(array(
            ...
            'class' => 'form-control _control-create-number text-right',
            'readonly' => true
        ));
        ?>
    </div>
...
<div class="form-group row">
    <?php echo form_label('Дүгнэлтээр гарсан эсэх', 'Дүгнэлтээр гарсан эсэх', array('required' => 'required', 'class' => 'col-md-4 control-label text-right', 'defined' => TRUE)); ?>
    <div class="col-md-8">
        <?php echo $controlNifsSolutionDropdown; ?>
    </div>
</div>
<div class="form-group row">
    <?php echo form_label('Дүгнэлт зөрсөн эсэх', 'Дүгнэлт зөрсөн эсэх', array('required' => 'required', 'class' => 'col-md-4 control-label text-right', 'defined' => TRUE)); ?>
    <div class="col-md-8"> <?php echo $controlNifsCloseTypeDropdown; ?></div>
</div>
<span id="closeTypeDescription">
<?php 
    if ($row->close_type_id == 22) {
        echo '<div class="form-group row">';
        echo form_label('Дүгнэлт', 'Дүгнэлт', array('required' => 'required', 'class' => 'col-md-4 control-label text-right', 'defined' => TRUE));
        echo '<div class="col-md-8">';

        echo form_textarea(array(
            'name' => 'closeTypeDescription',
            'id' => 'closeTypeDescription',
            'value' => $row->close_type_description,
            'rows' => 5,
            'class' => 'form-control'
        ));
        ...
        echo form_hidden('closeTypeDescription');
    }
?>
</span>
<?php echo form_close(); ?>