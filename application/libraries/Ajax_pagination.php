...
class Ajax_pagination{
    ...
    var $first_link      = 'Эхлэл';
    var $next_link       = '&#187;';
    var $prev_link       = '&#171;';
    var $last_link       = 'Төгсгөл';
    var $uri_segment     = 3;
    var $full_tag_open   = '<ul class="pagination-flat justify-content-center twbs-page-start pagination">';
    var $full_tag_close  = '</ul>';
    var $first_tag_open  = '<li class="prev">';
    var $first_tag_close = '</li>';
    var $last_tag_open   = '<li class="next">';
    var $last_tag_close  = '</li>';
    var $cur_tag_open    = '<li class="page-item active"><a href="javascript:;" class="page-link">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<ul class="pagination bootpag pagination-separated pagination-sm"><li class="result-info"><span>Үр дүн: ' . $this->total_rows . '</span></li></ul>';
            return $info;
        }
        ...
        if ($this->show_count){
            ...
            $info .= ' | Нийт ' . $this->total_rows;
            $output .= '<li class="result-info"><span>' . $info . '</span></li>';
        }
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<a class="page-link" href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'({page:'.$pageCount.', searchQuery: $(\'#root-container\').find(\'form\').serialize()})">'. $text .'</a>';
    }
}
